...
class TestControllerPerson(TransactionTestCase):
    ...
    # def test_a_getbyid_client_missing(self):
    ...
    # def test_a_getbyid_client_api_key_not_found(self):
    #     response = self.client.get('/api/v1/person/',
    #         REMOTE_ADDR='127.0.0.8',
    #         HTTP_API_KEY=self.model_login_merchant.token,
    ...
    # def test_a_getbyid_client_ip_error(self):
    #     response = self.client.get('/api/v1/person/',
    #         REMOTE_ADDR='127.0.0.8',
    #         HTTP_API_KEY=self.model_login_merchant.token,
    ...
    # def test_a_getbyid_client_not_verified(self):
    ...
    def test_a_getbyid_client_not_related(self):
    ...
    def test_a_getbyid_client_profile_error(self):
