...
class TestControllerPerson(TransactionTestCase):
    ...
    # def test_a_person_address_update_http_not_found(self):
    ...
    # def test_a_person_address_update_http_not_allowed(self):
    #     response = self.client.get('/api/v1/person/address/update/123/')

    #     self.assertEqual(response.status_code,405)
    #     self.assertTrue(isinstance(response,HttpResponseNotAllowed),'Não é um objeto do tipo "HttpResponseNotAllowed"')

    # def test_a_person_address_update_param_missing(self):
    #     data_post = {
    #         'state': '',
    #         'city': '',
    #         'number': '',
    ...
    # def test_a_person_address_update_param_incorrect(self):
    #     data_post = {
    #         'state': '',
    #         'city': '',
    #         'number': '',
    ...
    # def test_a_person_address_update_not_found(self):
    #     data_post = {
    #         'state': 'RS',
    #         'city': 'Porto Alegre',
    #         'number': '99',
    ...
    def test_a_person_address_update(self):
        data_post_a = {
            'state': 'RS',
            'city': 'Porto Alegre',
            'number': '99',
